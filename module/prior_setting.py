...
def prior_sw_width_1(pt2_nstates, pt3_nstates, sum_nstates): # square well
    ...
    prior['log(dE'+str(max_nstate-1)+')'] = gv.gvar(-1.25+np.log(2*4-1), 0.5/(2*4-1)*5) # garbage can
...
def prior_id1_width_1(pt2_nstates, pt3_nstates, sum_nstates): # 1/n
    ...
    prior['log(dE'+str(max_nstate-1)+')'] = gv.gvar(-1.25-np.log(4), 0.5*4*5) # garbage can
...
def prior_id2_width_1(pt2_nstates, pt3_nstates, sum_nstates): # 1/n**2
    ...
    prior['log(dE'+str(max_nstate-1)+')'] = gv.gvar(-1.25-2*np.log(4), 0.5*16*5) # garbage can
