...
int main(int argc, const char * argv[]) {
    ...
    const double m_N = 0.498; // Nuclear mass in lattice units
    const double m_pi = 0.1407; // Pion mass in lattice units
    const double p_quantum = M_PI/16.; // The momentum-quantum in this lattice (of length 24)
