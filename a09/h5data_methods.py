...
# Note: does a particle-in-a-box energy model if given e_decay_exp = -1
def prior(n_2pt_3pt, n_sumsub_FH, b, e_decay_exp):
	...
	prior['Z0'] = gv.gvar(0.00033, 0.00003)
	prior['Ztilde0'] = gv.gvar(0.0012, 0.0002)
	...
	#energyvals[0] = gv.gvar(0.50, 0.02)
	for k in range(1, n_2pt_3pt):
	    if e_decay_exp == particle_in_a_box_const:
	        dEvals[k-1] = 2*dE0*k - dE0
	    else:
	        dEvals[k-1] = dE0/np.power(float(k), e_decay_exp)
    ...
    #prior['Z1'] = gv.gvar(0.00033, 0.0004)
    #prior['Ztilde1'] = gv.gvar(0.0012, 0.0012)
    #prior['Z2'] = gv.gvar(0.00033, 0.0004)
    #prior['Ztilde2'] = gv.gvar(0.0012, 0.0012)
 
	prior['Z1'] = gv.gvar(0.0005, 0.0005)
	prior['Ztilde1'] = gv.gvar(0.004, 0.004)
	prior['Z2'] = gv.gvar(0.0005, 0.0005)
	prior['Ztilde2'] = gv.gvar(0.004, 0.004)

	for n in range(1, n_2pt_3pt):
	    #prior['log(dE{})'.format(n)] = gv.gvar(np.log(dEvals[n-1]), b)
            #print(np.log(dEvals[n-1]))
            prior['log(dE{})'.format(n)] = gv.gvar(np.log(dEvals[n-1]), b)
            if n > 2:
	    	...
	    	#prior['Ztilde{}'.format(n)] = gv.gvar(0.002, 0.002)
            	...
            	prior['Z{}'.format(n)] = gv.gvar(0.0005, 0.0005)
            	prior['Ztilde{}'.format(n)] = gv.gvar(0.004, 0.004)
	...
	if n_sumsub_FH > 2:
	    prior['Z_FHmax'] = gv.gvar(0.0005, 0.0005)
	    prior['Ztilde_FHmax'] = gv.gvar(0.004, 0.004)
...
def get_2pt(fname):
    ...
    return_array = np.array(file['gf1p0_w3p5_n45_M51p1_L56_a1p5']['spec']['ml0p00951']['proton']['px0_py0_pz0']['spin_up']) + np.array(file['gf1p0_w3p5_n45_M51p1_L56_a1p5']['spec']['ml0p00951']['proton']['px0_py0_pz0']['spin_dn']) + np.array(file['gf1p0_w3p5_n45_M51p1_L56_a1p5']['spec']['ml0p00951']['proton_np']['px0_py0_pz0']['spin_up']) + np.array(file['gf1p0_w3p5_n45_M51p1_L56_a1p5']['spec']['ml0p00951']['proton_np']['px0_py0_pz0']['spin_dn'])
    
    return np.array([[[np.real(return_array[i][j][k][0]) for k in range(2)] for j in range(64)] for i in range(784)])/4.

# Gets a 3-point data array with a specified gA or gV dataset and a tsep range
def get_3pt(fname, dataset, tsep_val): # tsep_min, tsep_max
    file = h5py.File(fname, "r")
    ...
    return_array = (np.array(file['gf1p0_w3p5_n45_M51p1_L56_a1p5']['formfac']['ml0p00951']['proton_UU_up_up_tsep_{}_sink_mom_px0_py0_pz0'.format(tsep_val)][dataset]['px0_py0_pz0']['local_curr'] ) - np.array(file['gf1p0_w3p5_n45_M51p1_L56_a1p5']['formfac']['ml0p00951']['proton_DD_up_up_tsep_{}_sink_mom_px0_py0_pz0'.format(tsep_val)][dataset]['px0_py0_pz0']['local_curr'] )) + spindn_coeff*(np.array(file['gf1p0_w3p5_n45_M51p1_L56_a1p5']['formfac']['ml0p00951']['proton_UU_dn_dn_tsep_{}_sink_mom_px0_py0_pz0'.format(tsep_val)][dataset]['px0_py0_pz0']['local_curr'] ) - np.array(file['gf1p0_w3p5_n45_M51p1_L56_a1p5']['formfac']['ml0p00951']['proton_DD_dn_dn_tsep_{}_sink_mom_px0_py0_pz0'.format(tsep_val)][dataset]['px0_py0_pz0']['local_curr'] )) - (np.array(file['gf1p0_w3p5_n45_M51p1_L56_a1p5']['formfac']['ml0p00951']['proton_np_UU_up_up_tsep_{}_sink_mom_px0_py0_pz0'.format(-tsep_val)][dataset]['px0_py0_pz0']['local_curr'] ) - np.array(file['gf1p0_w3p5_n45_M51p1_L56_a1p5']['formfac']['ml0p00951']['proton_np_DD_up_up_tsep_{}_sink_mom_px0_py0_pz0'.format(-tsep_val)][dataset]['px0_py0_pz0']['local_curr'] )) - spindn_coeff*(np.array(file['gf1p0_w3p5_n45_M51p1_L56_a1p5']['formfac']['ml0p00951']['proton_np_UU_dn_dn_tsep_{}_sink_mom_px0_py0_pz0'.format(-tsep_val)][dataset]['px0_py0_pz0']['local_curr'] ) - np.array(file['gf1p0_w3p5_n45_M51p1_L56_a1p5']['formfac']['ml0p00951']['proton_np_DD_dn_dn_tsep_{}_sink_mom_px0_py0_pz0'.format(-tsep_val)][dataset]['px0_py0_pz0']['local_curr'] ))
    
    if dataset in possible_gAsets:
        return np.array([[np.imag(return_array[j][k])/4. for k in range(len(return_array[j]))] for j in range(784)])
    
    else:
        return np.array([[np.real(return_array[j][k])/4. for k in range(len(return_array[j]))] for j in range(784)])
    
    #return_array = [(np.array(file['gf1p0_w3p5_n45_M51p1_L56_a1p5']['formfac']['ml0p00951']['proton_UU_up_up_tsep_{}_sink_mom_px0_py0_pz0'.format(i)][dataset]['px0_py0_pz0']['local_curr'] ) - np.array(file['gf1p0_w3p5_n45_M51p1_L56_a1p5']['formfac']['ml0p00951']['proton_DD_up_up_tsep_{}_sink_mom_px0_py0_pz0'.format(i)][dataset]['px0_py0_pz0']['local_curr'] )) + spindn_coeff*(np.array(file['gf1p0_w3p5_n45_M51p1_L56_a1p5']['formfac']['ml0p00951']['proton_UU_dn_dn_tsep_{}_sink_mom_px0_py0_pz0'.format(i)][dataset]['px0_py0_pz0']['local_curr'] ) - np.array(file['gf1p0_w3p5_n45_M51p1_L56_a1p5']['formfac']['ml0p00951']['proton_DD_dn_dn_tsep_{}_sink_mom_px0_py0_pz0'.format(i)][dataset]['px0_py0_pz0']['local_curr'] )) - (np.array(file['gf1p0_w3p5_n45_M51p1_L56_a1p5']['formfac']['ml0p00951']['proton_np_UU_up_up_tsep_{}_sink_mom_px0_py0_pz0'.format(-i)][dataset]['px0_py0_pz0']['local_curr'] ) - np.array(file['gf1p0_w3p5_n45_M51p1_L56_a1p5']['formfac']['ml0p00951']['proton_np_DD_up_up_tsep_{}_sink_mom_px0_py0_pz0'.format(-i)][dataset]['px0_py0_pz0']['local_curr'] )) - spindn_coeff*(np.array(file['gf1p0_w3p5_n45_M51p1_L56_a1p5']['formfac']['ml0p00951']['proton_np_UU_dn_dn_tsep_{}_sink_mom_px0_py0_pz0'.format(-i)][dataset]['px0_py0_pz0']['local_curr'] ) - np.array(file['gf1p0_w3p5_n45_M51p1_L56_a1p5']['formfac']['ml0p00951']['proton_np_DD_dn_dn_tsep_{}_sink_mom_px0_py0_pz0'.format(-i)][dataset]['px0_py0_pz0']['local_curr'] )) for i in range(tsep_min, tsep_max)]
    
    #if dataset in possible_gAsets:
        #return np.array([[[np.imag(return_array[i][j][k])/4. for k in range(len(return_array[i][j]))] for i in range(len(range(tsep_min, tsep_max))) ] for j in range(784)])
    
    #else:
        #return np.array([[[np.real(return_array[i][j][k])/4. for k in range(len(return_array[i][j]))] for i in range(len(range(tsep_min, tsep_max))) ] for j in range(784)])
    #if dataset in possible_gAsets:
        #return np.array([[[np.imag(return_array[i][j][k]) for k in range(64)] for i in range(10)] for j in range(784)])/4.
        
    #else:
        #return np.array([[[np.real(return_array[i][j][k]) for k in range(64)] for i in range(10)] for j in range(784)])/4.
