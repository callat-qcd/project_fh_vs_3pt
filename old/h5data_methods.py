...
def prior(n_2pt_3pt, n_sumsub_FH, b, e_decay_exp):
	...
	prior['Z1'] = gv.gvar(0.0008, 0.0008)
	prior['Ztilde1'] = gv.gvar(0.003, 0.003)
	prior['Z2'] = gv.gvar(0.0008, 0.0008)
	prior['Ztilde2'] = gv.gvar(0.003, 0.003)
	...
	for n in range(1, n_2pt_3pt):
	    ...
	    if n > 2:
	    	...
	    	prior['Z{}'.format(n)] = gv.gvar(0.0008, 0.0008)
	    	prior['Ztilde{}'.format(n)] = gv.gvar(0.003, 0.003)
	...
	if n_sumsub_FH > 2:
	    prior['Z_FHmax'] = gv.gvar(0.0008, 0.0008)
...
def get_3pt(fname, dataset, tsep_min, tsep_max):
    ...
    return_array = [(np.array(file['gf1p0_w3p0_n30_M51p2_L58_a1p5']['formfac']['ml0p0126']['proton_UU_up_up_tsep_{}_sink_mom_px0_py0_pz0'.format(i)][dataset]['px0_py0_pz0']['local_curr'] ) - np.array(file['gf1p0_w3p0_n30_M51p2_L58_a1p5']['formfac']['ml0p0126']['proton_DD_up_up_tsep_{}_sink_mom_px0_py0_pz0'.format(i)][dataset]['px0_py0_pz0']['local_curr'] )) + spindn_coeff*(np.array(file['gf1p0_w3p0_n30_M51p2_L58_a1p5']['formfac']['ml0p0126']['proton_UU_dn_dn_tsep_{}_sink_mom_px0_py0_pz0'.format(i)][dataset]['px0_py0_pz0']['local_curr'] ) - np.array(file['gf1p0_w3p0_n30_M51p2_L58_a1p5']['formfac']['ml0p0126']['proton_DD_dn_dn_tsep_{}_sink_mom_px0_py0_pz0'.format(i)][dataset]['px0_py0_pz0']['local_curr'] )) - (np.array(file['gf1p0_w3p0_n30_M51p2_L58_a1p5']['formfac']['ml0p0126']['proton_np_UU_up_up_tsep_{}_sink_mom_px0_py0_pz0'.format(-i)][dataset]['px0_py0_pz0']['local_curr'] ) - np.array(file['gf1p0_w3p0_n30_M51p2_L58_a1p5']['formfac']['ml0p0126']['proton_np_DD_up_up_tsep_{}_sink_mom_px0_py0_pz0'.format(-i)][dataset]['px0_py0_pz0']['local_curr'] )) - spindn_coeff*(np.array(file['gf1p0_w3p0_n30_M51p2_L58_a1p5']['formfac']['ml0p0126']['proton_np_UU_dn_dn_tsep_{}_sink_mom_px0_py0_pz0'.format(-i)][dataset]['px0_py0_pz0']['local_curr'] ) - np.array(file['gf1p0_w3p0_n30_M51p2_L58_a1p5']['formfac']['ml0p0126']['proton_np_DD_dn_dn_tsep_{}_sink_mom_px0_py0_pz0'.format(-i)][dataset]['px0_py0_pz0']['local_curr'] )) for i in range(tsep_min, tsep_max)]
    
    if dataset in possible_gAsets:
        return np.array([[[np.imag(return_array[i][j][k])/4. for k in range(len(return_array[i][j]))] for i in range(len(range(tsep_min, tsep_max))) ] for j in range(1053)])
    
    else:
        return np.array([[[np.real(return_array[i][j][k])/4. for k in range(len(return_array[i][j]))] for i in range(len(range(tsep_min, tsep_max))) ] for j in range(1053)])
