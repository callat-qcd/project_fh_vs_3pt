"""
Django settings for fh_db project.
...
ROOT_URLCONF = "fh_db.config.urls"
...
WSGI_APPLICATION = "fh_db.config.wsgi.application"
...
MIGRATION_MODULES = {"notifications": "fh_db.config.migrations.notifications"}
